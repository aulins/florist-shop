...
export default function Footer() {
    return (
        <footer className="relative border-t border-pink-200 py-16 bg-gradient-to-b from-white to-pink-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid md:grid-cols-3 gap-12 mb-12">
                    ...
                    <div>
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h3 className="text-2xl font-bold bg-gradient-to-r from-pink-500 to-rose-400 bg-clip-text text-transparent">Florist Shop ✨</h3>
                        </div>
                        ...
                        <ul className="space-y-3">
                            <li>
                                <Link href="/" className="text-gray-600 hover:text-pink-500 transition-colors flex items-center gap-2 group">
                                    <span className="text-pink-400 group-hover:translate-x-1 transition-transform">▸</span> Home
                                </Link>
                            </li>
                            <li>
                                <Link href="/products" className="text-gray-600 hover:text-pink-500 transition-colors flex items-center gap-2 group">
                                    <span className="text-pink-400 group-hover:translate-x-1 transition-transform">▸</span> Products
                                </Link>
                            </li>
                            <li>
                                <Link href="/about" className="text-gray-600 hover:text-pink-500 transition-colors flex items-center gap-2 group">
                                    <span className="text-pink-400 group-hover:translate-x-1 transition-transform">▸</span> About Us
                                </Link>
                            </li>
                            <li>
                                <Link href="/contact" className="text-gray-600 hover:text-pink-500 transition-colors flex items-center gap-2 group">
                                    <span className="text-pink-400 group-hover:translate-x-1 transition-transform">▸</span> Contact
                                </Link>
                            </li>
                        </ul>
                    </div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-700">Bandung, Indonesia</p>
                                </div>
                            </li>
                        </ul>
                    </div>
                ...
                <div className="border-t border-pink-200 pt-8">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        <p className="text-gray-600 text-sm">© 2025 Florist Shop. All rights reserved.</p>
                        <p className="text-gray-600 text-sm flex items-center gap-2">
                            Made with <span className="text-pink-400 animate-pulse">💖</span> for beautiful moments
                        </p>
                    </div>
                </div>
            </div>
            ...
            {/* Decorative sparkles */}
            <div className="absolute top-10 right-10 text-pink-300/30 text-3xl animate-spin-slow hidden lg:block">✧</div>
            <div className="absolute bottom-20 left-20 text-pink-300/30 text-2xl animate-bounce-slow hidden lg:block">🌸</div>
        </footer>
    );
}
